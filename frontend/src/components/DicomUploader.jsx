    ...
    <div
      ...
      className={`relative flex flex-col items-center justify-center gap-3
        ...
        ${isDragActive
          ...
          : 'border-gray-300 hover:border-gray-400 bg-gray-50 dark:border-gray-700 dark:hover:border-gray-500 dark:bg-gray-900'
        }`}
    >
      <input {...getInputProps()} />
      ...
      {file ? (
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 dark:text-gray-600 text-xs mt-2">.dcm .dicom .png .jpg .jpeg</p>
        </div>
      )}
    </div>
  )
