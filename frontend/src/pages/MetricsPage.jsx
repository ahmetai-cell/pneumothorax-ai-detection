...
function Spinner() {
  return (
    <div className="flex items-center gap-3 text-gray-500 dark:text-gray-400 text-sm py-8">
...
function ThresholdBadge({ label, value }) {
  return (
    <div className="flex items-center justify-between px-4 py-2 rounded-lg bg-gray-100 border border-gray-200 dark:bg-gray-800/60 dark:border-gray-700">
...
export default function MetricsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 space-y-10">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">Model Performans Metrikleri</h1>
      ...
      {health && (
        <div className="card p-4 flex flex-wrap gap-4 items-center justify-between">
          ...
          <div className="flex flex-wrap gap-3 text-xs text-gray-500 dark:text-gray-400">
            <span>Cihaz: <span className="text-gray-800 dark:text-gray-200 font-mono">{device}</span></span>
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="card p-4">
              <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Metrik Radar</p>
              <ResponsiveContainer width="100%" height={260}>
                <RadarChart data={radarData}>
                  <PolarGrid stroke="#d1d5db" className="dark:[stroke:#374151]" />
                  <PolarAngleAxis
                    dataKey="metric"
            ...
            <div className="card p-4 space-y-3">
              <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">Eşik Değerleri & Model Bilgisi</p>
              <ThresholdBadge
      ...
      {results?.folds && results.folds.length > 0 && (
        <div className="space-y-3">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Fold Detayları</h2>
      ...
      {!loading && !error && Object.keys(summary).length === 0 && (
        <div className="text-center py-16 space-y-3">
          <p className="text-gray-500 dark:text-gray-400 text-lg">Henüz sonuç yok</p>
